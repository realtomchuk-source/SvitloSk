...
/**
 * Premium SvitloSk Logo Icon
 * Features rounded corners (squircle-like) and two-tone brand colors.
 */
export const MainLogoIcon: React.FC<MainLogoIconProps> = ({ size = 512, className }) => {
    return (
        <svg 
            width={size} 
            height={size} 
