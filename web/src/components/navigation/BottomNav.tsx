...
const NavItem: React.FC<NavItemProps> = ({ to, label, active, children }) => (
...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="glass-nav">
      ...
      <NavItem to="/archive" label="Archive" active={location.pathname === '/archive'}>
      ...
      <NavItem to="/apps" label="App" active={location.pathname === '/apps'}>
      ...
      <NavItem to="/cabinet" label="Profile" active={location.pathname === '/cabinet'}>
