          ...
          {selectedHouse && foundSubGroupVal && (
            <div className={styles.onboardingCard} style={{ animation: 'fadeIn 0.4s ease' }}>
              ...
              <p className={styles.onboardingText}>
                Не знайшли потрібну адресу? Ймовірно, вона відсутня у відкритих джерелах. Надішліть запит — і допоможіть нам зробити SvitloSk повнішим та кориснішим для всіх користувачів.
              </p>
              <button
                onClick={() => setIsMissingFormOpen(true)}
                className={`${styles.capsuleBtn} ${styles.capsuleOrange}`}
